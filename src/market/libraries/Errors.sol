...
library Errors {
    ...
    error INVALID_MAXIMUM_MATURITY(uint256 maxMaturity);
    ...
    error PAST_MATURITY(uint256 maturity);
    ...
    error MATURITY_OUT_OF_RANGE(uint256 maturity, uint256 minTenor, uint256 maxTenor);
    error INVALID_MATURITY(uint256 maturity);
    error INVERTED_OFFERS(address account, uint256 maturity);
