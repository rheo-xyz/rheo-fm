...
j=$((0x10)); 
SOLIDITY_FILES=$(find src/market/libraries src/market/token/libraries lib/rheo-solidity/src/factory/libraries test/helpers/libraries -type f | sed 's/.*\///' | sed 's/\.sol//')
