...
contract GenericMarket_wstETH_ETH_Test is BaseTestGenericMarket {
    ...
    function test_GenericMarket_wstETH_ETH__valueToCollateral() public view {
        assertEqApprox(_valueToCollateral(1e18), 0.848e18, 0.001e18);
    }
    ...
    function test_GenericMarket_wstETH_ETH_collateralRatio() public {
        ...
        uint256 debtPositionId = _sellCreditMarket(bob, alice, RESERVED_ID, 0.5e18, _maturity(150 days), false);
