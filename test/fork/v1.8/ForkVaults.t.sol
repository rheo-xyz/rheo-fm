...
contract ForkVaultsTest is ForkTest, Networks {
    ...
    function testFork_ForkVaults_eUSDC22() public {
        ...
        vm.prank(owner);
        borrowTokenVault.setVaultAdapter(address(eUSDC22), ERC4626_ADAPTER_ID);
    ...
    function testFork_ForkVaults_morphoUSUALUSDCplus() public {
        ...
        vm.prank(owner);
        borrowTokenVault.setVaultAdapter(address(morphoUSUALUSDCplus), ERC4626_ADAPTER_ID);
    ...
    function testFork_ForkVaults_liquidUSD() public {
        ...
        vm.prank(owner);
        vm.expectRevert();
        borrowTokenVault.setVaultAdapter(address(liquidUSD), ERC4626_ADAPTER_ID);
